...
<body>
	...
	<caption>회원가입</caption>
		...
		name="pass" id="pass"  placeholder="숫자네자리" required="required">
		
		
		<input type="password" style=" width: 120px;" class="form-control"
		name="pass" id="pass2"  placeholder="숫자네자리" required="required">
		...
		<tr>
			...
			placeholder="(-)없이 hp숫자입력 " required="required"> 
